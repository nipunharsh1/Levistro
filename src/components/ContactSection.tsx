          ...
          {submitted ? (
            <div className="py-16 text-center animate-in zoom-in-95 duration-300">
              ...
              <p className="text-slate-600 dark:text-gray-300 max-w-md mx-auto text-sm leading-relaxed mb-8">
                Thank you, <span className="text-teal-600 dark:text-cyan-300 font-semibold">{formData.name || 'Visionary'}</span>. Our Managing Director is reviewing your scope and will respond within 4 hours.
              </p>
            ...
            <form onSubmit={handleSubmit} className="space-y-8">
              ...
              <div>
                <label className="block text-xs uppercase font-bold tracking-wider text-cyan-600 dark:text-cyan-400 mb-3">
