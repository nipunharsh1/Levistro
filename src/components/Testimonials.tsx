...
const testimonials = [
  {
    id: 1,
    quote:
      'Levistro built our enterprise ERP and cloud inventory system ahead of schedule. Our warehouse fulfillment speed improved by 340% with zero data errors.',
    author: 'David Chen',
  ...
  },
  {
    id: 2,
    quote:
      'The cross-platform mobile app Levistro engineered for us is rock solid. Our drivers and customers love the speed, live GPS, and smooth booking experience.',
    author: 'Sarah Lin',
    role: 'Product Lead',
  ...
  },
  {
    id: 3,
    quote:
      'Our new LMS platform handles over 85,000 concurrent students without any latency. Video courses stream effortlessly and certificate generation is fully automated.',
    author: 'Jonathan Sterling',
    role: 'Head of Learning',
    company: 'Solaria Academy',
    metrics: '85K+ Active Learners',
    avatar: 'JS',
