...
const Services: React.FC<ServicesProps> = ({ onSelectService }) => {
  return (
    <section id="services" className="py-28 bg-[#07090E] relative overflow-hidden">
      {/* Glow Backdrops */}
          ...
          {services.map((item) => {
            ...
            return (
              <div
                ...
                className={`group relative rounded-3xl p-8 sm:p-10 glass-panel border border-white/10 ${item.borderColor} transition-all duration-300 hover:-translate-y-1.5 cursor-pointer overflow-hidden ${item.colSpan}`}
              >
                ...
                <div className="relative z-10 flex flex-col h-full justify-between">
                  <div>
                    ...
                    <div className="flex items-center justify-between mb-8">
                      <div className="w-14 h-14 rounded-2xl bg-white/[0.05] border border-white/10 flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                    ...
                    <p className="text-sm font-medium text-teal-400/90 mb-4">{item.tagline}</p>
                  ...
                  <div className="pt-4 border-t border-white/5 flex items-center justify-between">
                    <span className="text-xs font-bold tracking-wider uppercase text-gray-400 group-hover:text-white transition-colors">
                      Discuss Scope & Pricing
                    </span>
                    <div className="w-8 h-8 rounded-full bg-white/5 group-hover:bg-cyan-500 group-hover:text-[#07090E] flex items-center justify-center text-gray-300 transition-all duration-300">
