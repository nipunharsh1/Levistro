...
const Team: React.FC = () => {
  return (
    <section id="team" className="py-28 bg-[#07090E] relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {team.map((member) => (
            <div
              key={member.id}
              className="group relative rounded-3xl p-6 glass-panel border border-white/10 hover:border-cyan-500/40 transition-all duration-300 hover:-translate-y-2 flex flex-col justify-between"
            >
              <div>
                {/* Avatar Display */}
                <div className="relative mb-6">
                  ...
                  <div className="absolute -bottom-2 -right-2 px-2.5 py-0.5 rounded-full bg-[#07090E] border border-white/10 text-[10px] font-bold text-teal-400 flex items-center gap-1 shadow-md">
                ...
                <p className="text-xs font-semibold text-teal-400 mb-1">{member.role}</p>
                <p className="text-[11px] text-gray-400 font-medium mb-3">{member.specialty}</p>
              ...
              <div className="flex items-center gap-2 pt-6 mt-6 border-t border-white/5">
                {member.socials.linkedin && (
                  <a
                    ...
                    className="p-2 rounded-lg bg-white/5 hover:bg-cyan-500 hover:text-black text-gray-400 transition-colors"
                    aria-label="LinkedIn"
                  >
